    ...
    return (
        ...
        <section className = "w-full bg-radial from-slate-700 to-zinc-950 flex flex-col mb-0">
            ...
            <div className = "w-full flex flex-wrap gap-16 justify-center px-6 mx-auto mb-16">
                ...
                {/* Design Work Button */}
                <button className = "w-full max-w-sm md:max-w-lg h-[550px] md:h-[800px] rounded-4xl bg-linear-to-b from-fuchsia-600 to-zinc-500 hover:scale-105 hover:bg-sky-500 duration-300 flex flex-col">
                    {/* Design Work Button Image */}
                    <img
                        src = "/Lion Line Art Transparent 1200-1200.png" 
                        alt = "Designs Preview" 
                        className = "w-64 md:w-80 h-64 md:h-80 object-contain overflow-visible mb-4 mt-12 mx-auto bg-[#28211e] rounded-full ring-24 ring-[#28211e]"
                    />
                ...
                <LinkButton 
                    ...
                    className = "w-full max-w-sm md:max-w-lg h-[550px] md:h-[800px] rounded-4xl bg-linear-to-b from-sky-500 to-zinc-500 hover:scale-105 hover:bg-sky-500 duration-300 flex flex-col"
                    >
                    ...
                    <div className = "flex grow flex-col justify-center items-center mx-8 lg:mx-0">
                        ...
                        <p className = "max-w-md text-center text-xl md:text-2xl text-gray-300 mt-5 md:mt-10 italic">My coding work including Java GUIs, SQL queries, and Python analytics</p>
                    </div>  
                </LinkButton>    
